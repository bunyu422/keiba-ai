...
dfs = [
    df[['レースID', '馬番', 'pred_score_1', 'is_win', 'オッズ', '単勝オッズ', '人気']],
...
val_df.to_csv(f'./csv/{field}_result_stacking_test_{fold}.csv', index=False)
test_df.to_csv(f'./csv/{field}_result_stacking_2025_{fold}.csv', index=False)